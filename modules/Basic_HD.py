...
class DenseHDTrainer():
    ...
    def sync_classify(self):
        self.model.classify_weights.data = F.normalize(self.model.classify_weights.data)
        self.model.classify.weight.data.copy_(self.model.classify_weights.data)
    ...
    def retrain(self, train_loader, model, epoch):
        ...
        with torch.no_grad():
            ...
            for i, (proj_in, proj_mask, proj_labels, unproj_labels, path_seq, path_name, p_x, p_y, proj_range, unproj_range, _, _, _, _, npoints) in enumerate(tqdm(train_loader, desc="Retraining")):
                ...
                model.classify.weight.data.copy_(F.normalize(model.classify_weights.data))
