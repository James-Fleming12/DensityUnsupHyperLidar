...
def main():
    ...
    parser.add_argument('--method', type=str, choices=['frozen', 'density', 'exp_a', 'exp_a_anchor_off', 'exp_a_anchor_on', 'exp_a_safe', 'exp_a_v2', 'exp_density_hybrid', 'all'], default='density', help='Method to test.')
