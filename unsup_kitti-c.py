...
def main():
    ...
    save_degradation_plot(os.path.join(args.log_dir, 'degradation_miou.png'), 'KITTI-C', results_miou, metric='mIoU')
    save_degradation_plot(os.path.join(args.log_dir, 'degradation_acc.png'), 'KITTI-C', results_acc, metric='Accuracy')
